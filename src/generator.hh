...
public:
    ...
    Port &port(const PortPackedStruct &p);
    Port &port(const PortPackedStruct &p, const std::string &port_name);
    Port &port(const EnumPort &p);
    Port &port(const EnumPort &p, const std::string &port_name);
